.module.rcbase:2022.06.23; /风控检查(可能在ft或fe中加载)
...
chkmaxordamt:{[x;y;s;sd;pe;q;p](q*p*getmultiple[s])>0f^risklimit[x;y;s;$[sd=.enum`BUY;`maxordbuyamt;`maxordsellamt]]}; /检查单笔最大买卖金额

chkmaxfund:{[x;y;s;sd;pe;q;p]if[pe<>.enum`OPEN;:0b];if[p<=0f;p:.db.QX[s;$[sd=.enum`BUY;`sup;`inf]]];om:abs getfrozen[(s;sd;pe;q;q*p*getmultiple[s])];pm:0f|0f^ffill .db.Ts[x;`margin];fm:abs frozenfund[x;y];(om>availfund[x])|(om+fm+pm)>risklimit[x;y;s`maxfund]}; /检查总可用资金限制
chkmaxfundord:{[x;y;s;sd;pe;q;p]if[pe<>.enum`OPEN;:0b];if[p<=0f;p:.db.QX[s;$[sd=.enum`BUY;`sup;`inf]]];om:abs getfrozen[(s;sd;pe;q;q*p*getmultiple[s])];om>risklimit[x;y;s;`maxfundord]}; /检查单笔委托资金占用
...
.db.RR,:((`maxprdpos;1b;0b;`qty;`chkmaxprdpos;`$"同品种总持仓限额");(`maxpos;1b;0b;`qty;`chkmaxpos;`$"总持仓限额");(`maxday;1b;0b;`qty;`chkmaxday;`$"当日开仓限额");(`maxord;1b;0b;`qty;`chkmaxord;`$"单笔开仓限额");(`maxordqty;1b;0b;`qty;`chkmaxordqty;`$"单笔数量限额");(`maxordamt;1b;0b;`amt;`chkmaxordamt;`$"单笔金额限额");(`maxspeed;1b;0b;`speed;`chkmaxspeed;`$"委托流速限额");(`maxcxlspeed;1b;1b;`speed;`chkmaxcxlspeed;`$"撤单流速限额");(`maxfund;0b;0b;`fund;`chkmaxfund;`$"可用资金限额");(`maxfundord;1b;0b;`fund;`chkmaxfundord;`$"单笔资金限额");(`maxordcnt;1b;0b;`cnt;`chkmaxordcnt;`$"委托笔数限额");(`maxcxlcnt;1b;1b;`cnt;`chkmaxcxlcnt;`$"撤单笔数限额");(`maxrejcnt;1b;0b;`cnt;`chkmaxrejcnt;`$"拒绝笔数限额"));
