...
btclose:{[x]cxlall[`bt];simfill[now[];1b];{[s]if[0<lq:0f^.db.P[`bt`bt,s;`lqty];limit_sell[`bt;s;lq;0f;`eot]];if[0>sq:0f^.db.P[`bt`bt,s;`sqty];limit_buy[`bt;s;neg[sq];0w;`eot]];} each exec sym from .db.P where 0<lqty|neg[sqty];simfill[now[];1b];};
