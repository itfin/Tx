...
.db.Ts.qtx[`syms`TP]:(`symbol$();([sym:`symbol$()];stop:`boolean$();logpx:`boolean$();pxbase:`float$();qtybase:`float$();nup:`long$();ndn:`long$();pxref:`float$();qtyref:`float$();pxask:`float$();qtyask:`float$();pxbid:`float$();qtybid:`float$();stepup:`float$();stepdn:`float$();qtyups:`float$();qtydnl:`float$();posinf:`float$();possup:`float$();stepupmap:();stepdnmap:();qtyupsmap:();qtydnlmap:();spreadmax:`float$();closelongrange:();closeshortrange:();oidup:();oiddn:()));
