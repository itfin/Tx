.module.tsalgofuex:2024.01.03; /算法交易期货修正
...
//----ChangeLog----
//2024.11.04:更新algo_updhvpn以支持期权
//2024.01.03:algo_updhvpn移除对pdstat的自动调用,改为需要手工调用,因为在长假结束后的历史统计缺乏夜盘信息
//2023.11.21:algo_updhvpn增加对pdstat的调用以及时更新新增合约的历史统计
