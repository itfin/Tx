gcc -g -std=c++11 -m64 -DJ64 -DKXVER=3 -fPIC -shared -lm -lpthread -I. -I ../ -L../../dll/l64 -lHSNsqApi extfqhsnsq.cpp -o ../../dll/l64/extfqhsnsq.so -Wno-write-strings -Wno-write-strings -Wno-unused-value -fpermissive
